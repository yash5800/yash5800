...
$ cat about.txt
> I build production-ready applications powered by AI.
...
- **Agentic AI with LangGraph** — Building production-ready AI agents
- **AI-Integrated Applications** — LLMs, RAG, tool-calling, multi-agent workflows
- **New AI Models** — Exploring latest LLMs and TTS models
- **Production Deployment** — Vercel, Docker, CI/CD pipelines
